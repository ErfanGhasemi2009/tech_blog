        ...
        child: Obx(
          () => Column(
            ...
            GestureDetector(
              ...
              child:TitleListHomeScreen(title: MyStrings.editTitleArticle, icon: Assets.icons.bluePen.image())
            ...
            GestureDetector(
              ...
              child: TitleListHomeScreen(title: MyStrings.editMainTextArticle, icon: Assets.icons.bluePen.image())
            ),
            ...
            GestureDetector(
              ...
              child: TitleListHomeScreen(title: MyStrings.selectCategory, icon: Assets.icons.bluePen.image())
            ),
            Padding(
              padding: EdgeInsets.all(Dimens.halfBodyMargin),
              child: Text(
